    ...
    >
      ...
      <div className="relative mb-5">
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-white/50 hover:text-blue-400 transition text-xl"
        >
          {showPassword ? '\u{1F512}' : '\u{1F441}'}
        </button>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-2">
          {checklistItems.map((item) => (
            ...
            >
              <div
                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center text-xs mr-3 transition ${
